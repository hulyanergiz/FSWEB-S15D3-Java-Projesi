...
String string="When the offensive resumed, the Turks received their first victory when the Greeks encountered stiff resistance in the battles of First and Second İnönü,"
...
String updatedString=string.toLowerCase().replaceAll("[.,\"'!?]","");
String[] words=updatedString.split("\\s+");
Map<String,Integer> countsOfWords=new HashMap<>();
for(String word:words){
countsOfWords.put(word,(countsOfWords.containsKey(word)?countsOfWords.get(word):0)+1);

}
        System.out.println(countsOfWords);
    }
}
